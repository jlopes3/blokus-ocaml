...
let test_get_pieces_reps _ =
  assert_equal (get_pieces_reps ["1";"2"]) @@ [("1","1");("2", "1"); ("2", "2")]

let data82= [["0";"2"]; ["0";"2"]; ["0";"2"]; ["0"; "2"]; ["G"; "Y"]; ["R"]];;

let test_score_string _ =
  assert_equal (score_string data82) @@  "\nRed score: " ^ "2" ^ "\n" ^ "Yellow score: " ^ "2" ^ "\n" ^ "Blue score: " ^ "2" ^ "\n" ^ "Green score: " ^ "2" ^ "\n";
  assert_equal (combine_strings_with_newline "a" "b") @@ "a\nb"

let data91= [["1"]; ["0";"2"]; ["0";"2"]; ["0"; "2"]; ["G"; "Y"]; ["R"]];;

let test_get_pieces _ =
  assert_equal (get_pieces "R" data91) @@ [piece1String]

let test_check_possible_rep_valid _ =
  assert_equal (check_possible_rep_valid ("1","1") (data91, empty_board)) @@ true;
  assert_equal (piece_rep_do_possible_move_coords empty_board [["P";"P";"P"];["P";"P";"P"];["P";"P";"P"]] "R") @@ "A1"

let data101 = [["1";"2"];["1";"2"];["1";"2"];["1";"2"];[];["R"]];;
let data101after = [["2"];["1";"2"];["1";"2"];["1";"2"];[];["Y"]];;
let nonempty_board: string list list = [["R";"R";"R";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"Y"];["R";"R";"R";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["R";"R";"R";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-"];["G";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"-";"B"]];;


let test_play_piece _ =
...
let part1_tests = "Part 1" >: test_list [
  ...
  "test_get_pieces_reps" >:: test_get_pieces_reps;
  "test_score_string" >:: test_score_string;
